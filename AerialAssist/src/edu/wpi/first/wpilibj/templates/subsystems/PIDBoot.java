 ...
 * @author AJ
 */
public class PIDBoot extends PIDSubsystem {
    ...
    public PIDBoot() {
        super("PIDBoot", Kp, Ki, Kd);
        LiveWindow.addActuator("PIDBoot", "RPMs", getPIDController());
    ...
    protected void usePIDOutput(double output) {
        ...
        System.out.println("[PIDBoot] Output : " + output);
